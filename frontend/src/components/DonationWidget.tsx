...
export default function DonationWidget() {
  ...
  return (
    <motion.div
      ...
      className="z-10 relative max-w-md mx-auto mt-20 mb-10 pointer-events-auto"
    >
      <GlassCard className="p-8 flex flex-col items-center justify-center text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
          <a
            href={upiUrl}
            className="flex-1 px-6 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors duration-300 text-white/90 font-medium text-sm text-center"
          >
            Pay with UPI ID
          </a>
